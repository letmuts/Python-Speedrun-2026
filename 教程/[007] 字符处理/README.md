...
字面量文档: <https://docs.python.org/zh-cn/3/reference/lexical_analysis.html#literals>
...
转义规则文档: <https://docs.python.org/zh-cn/3/reference/lexical_analysis.html#escape-sequences>
...
格式化语法文档: <https://docs.python.org/zh-cn/3/library/string.html#format-string-syntax>
...
`{!r}` 是调用 [`repr` 内置函数](https://docs.python.org/zh-cn/3/library/functions.html#repr)，这个函数能还原对象构造时的代码，对应特殊方法 `__repr__`
